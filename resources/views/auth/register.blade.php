...
<head>
  ...
  <!-- Google Fonts -->
  <link href="public\img\favicon.png" rel="preconnect">
...
<body>
                ...
                <div class="card-body">
                  ...
                  @enderror
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="yourEmail" value="{{ old('email') }}" required autocomplete="email">
                      @error('email')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                  @enderror
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="yourUsername" required autocomplete="new-password">
                        @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                      <input type="password" name="password_confirmation" class="form-control mt-4" id="password-confirm" required autocomplete="new-password">
                    </div>
                </div>
  ...
  <script src="{{ asset('resources/assets/vendor/chart.js/chart.umd.js') }}x"></script>
