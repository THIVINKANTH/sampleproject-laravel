              ...
              <div class="card-body">
                  ...
                  <form action="{{ url('invoiceinsert') }}" method="POST">
                      ...
                      <div class="row">
                          <div class="col mb-3">
                              ...
                              <div class="col-sm-10">
                                <input class="form-control" type="text" id="formFile" name="invoivename">
                              </div>
                            </div>
                          <div class="col mb-3">
                              <label for="inputText" class="col-sm-10 col-form-label">Address</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" id="formFile" name="invoiceaddress">
                              </div>
                            </div>
                            <div class="col mb-3">
                              <label for="inputNumber" class="col-sm-10 col-form-label">Contact</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" id="formFile" name="invoicecontact">
                              </div>
                            </div>
                      </div>
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td>{{ $i }}</td>
                          <td><input class="form-control itemname" type="text" name="itemname[]"></td>
                          <td><input class="form-control hsn" style="width: 90px" type="text" name="hsn[]"></td>
                          <td><input class="form-control quantity" style="width: 90px" type="number" name="quantity[]"></td>
                          <td><input class="form-control unit" style="width: 90px" type="text" name="unit[]"></td>
                          <td><input class="form-control price" style="width: 130px" type="number" name="price[]"></td>
