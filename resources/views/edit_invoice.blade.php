        ...
        <div class="col">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action={{ url('/updateinvoice',$edits->id) }}>
                @csrf
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Company Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="ucompanyname" value="{{ $edits->invoicecompanyname }}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Address</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="uaddress" value="{{ $edits->address}}">
                  </div>
                </div>
                <div class="row mb-3">
                    <label for="inputNumber" class="col-sm-2 col-form-label">Contact</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="ucontact" value="{{ $edits->contact }}">
                    </div>
                  </div>
